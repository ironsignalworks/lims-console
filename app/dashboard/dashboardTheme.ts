...
export function dashboardTokens(light: boolean) {
  ...
  return {
    ...
    sidebarBrandSub: L ? "text-slate-600" : "text-slate-300",
    sidebarTitle: L ? "text-slate-900" : "text-slate-50",

    navInactive: L
      ? "text-slate-600 hover:bg-slate-100 hover:text-slate-900 border border-transparent"
      : "text-slate-300 hover:bg-white/[.05] hover:text-slate-50 border border-transparent",
    navActive: L
    ...
    headerKicker: L ? "text-slate-600" : "text-slate-300",
    ...
    mobileNavInactive: L ? "text-slate-600" : "text-slate-300",
    ...
    settingsMenuTitle: L ? "text-slate-600" : "text-slate-300",
    settingsRow: L
    ...
    settingsFoot: L ? "border-slate-200/80 text-slate-600" : "border-white/[.08] text-slate-300",

    kpiCard: L
      ? "rounded-xl border border-slate-200/80 bg-white p-4 shadow-sm"
      : "rounded-xl border border-white/[.08] bg-[#243041] p-4",
    kpiLabel: L ? "text-slate-600" : "text-slate-300",
    kpiValue: L ? "text-slate-900" : "text-slate-50",
    kpiDelta: L ? "text-slate-600" : "text-slate-300",
    ...
    bodyText: L ? "text-slate-600" : "text-slate-300",
    bodyTextSoft: L ? "text-slate-600" : "text-slate-300",
    accentLabel: L
    ...
    tableHead: L
      ...
      : "border-b border-white/[.08] text-xs font-medium tracking-wide text-slate-300",
    tableRow: L
    ...
    strainMuted: L ? "text-slate-600" : "text-slate-300",
    strainMeta: L ? "text-slate-600 font-mono text-xs" : "text-slate-300 font-mono text-xs",
    hintArrow: L ? "text-slate-500 group-hover:text-[#0d7377]" : "text-slate-400 group-hover:text-[#5eead4]",
    ...
    runsMeta: L ? "text-slate-600" : "text-slate-300",
    runsStage: L ? "text-slate-600" : "text-slate-300",
    ...
    pillInactive: L ? "text-slate-600 hover:text-slate-900" : "text-slate-300 hover:text-slate-50",
    pillActive: L
    ...
    codePre: L ? "text-slate-600" : "text-slate-300",

    footNote: L ? "text-slate-600" : "text-slate-300",
    ...
    importDrop: (drag: boolean) =>
      drag
        ...
        : L
          ...
          : "rounded-xl border border-dashed border-white/[.14] bg-white/[.03] text-slate-300",
    ...
    importPre: L
      ...
      : "text-sm leading-relaxed font-mono text-slate-300 whitespace-pre-wrap break-words border border-white/[.08] rounded-lg p-3 bg-[#151c28] max-h-[min(36vh,320px)] overflow-y-auto",
    dlDt: L ? "text-slate-600" : "text-slate-300",
...
export function drawerTokens(light: boolean) {
  ...
  return {
    ...
    kicker: L ? "text-slate-600" : "text-slate-300",
    ...
    dt: L ? "text-slate-600 text-xs mb-0.5" : "text-slate-300 text-xs mb-0.5",
    ...
    auditDate: L ? "text-slate-600 font-mono shrink-0" : "text-slate-300 font-mono shrink-0",
    notes: L ? "text-slate-600" : "text-slate-300",
  };
}
...
export function drawerForm(light: boolean) {
  ...
  return {
    ...
    metaLine: L ? "text-xs text-slate-600 font-mono" : "text-xs text-slate-300 font-mono",
    ...
    emptyHint: L ? "text-xs text-slate-600" : "text-xs text-slate-300",
    removeLink: L
