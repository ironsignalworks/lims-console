...
const chartUi = {
  ...
  metricBox: (s: ChartSurface) =>
    s === "light"
      ...
      : "rounded-lg border border-white/[.1] bg-[#1a2332] px-2.5 py-1.5 w-full h-full",
  metricGreen: (s: ChartSurface) =>
    s === "light"
      ? "rounded-lg border border-[#0d7377]/20 bg-[#0d7377]/[.06] px-2.5 py-1.5 w-full h-full"
      : "rounded-lg border border-[#0d7377]/25 bg-[#0d7377]/8 px-2.5 py-1.5 w-full h-full",
...
export function StrainStatusStackBar({
  ...
  const segs = [
    { key: "complete", n: counts.complete, className: "bg-[#0d7377]/80", label: "Indexed" },
  ...
  return (
    <div className={chartUi.card(surface)}>
      <div className="mb-3 flex flex-wrap items-start justify-between gap-2">
        <div>
          <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]" : "text-[#5eead4]"}`}>
            LIMS status mix
          </p>
        ...
        <ChartMetricSlot
          ...
          ghost={
            <div className="rounded-lg border border-transparent px-2.5 py-1.5">
              <p className="text-xs font-medium tracking-wide">QC hold</p>
        ...
        >
          {hoverSeg ? (
            <div className={chartUi.metricBox(surface)}>
              <p className={`text-xs font-medium tracking-wide ${chartUi.sub9(surface)}`}>
                {hoverSeg.label}
              </p>
          ...
          {segs.length === 0 ? (
            ...
            segs.map((s) => (
              <button
                ...
                className={`relative h-full min-w-[8px] ${s.className} transition-[width,filter] duration-300 ease-out hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#0d7377]/60`}
  ...
  return (
    <div className={chartUi.card(surface)}>
      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
        <div>
          <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]" : "text-[#5eead4]"}`}>Mean Q30 (10 runs)</p>
        ...
        <ChartMetricSlot
          ...
          ghost={
            <div className="rounded-lg border border-transparent px-2.5 py-1.5">
              <p className="text-xs font-medium tracking-wide">R-10</p>
        ...
        >
          {hoverIdx !== null ? (
            <div className={chartUi.metricGreen(surface)}>
              <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]/80" : "text-[#5eead4]/80"}`}>{runLabel(hoverIdx)}</p>
              <p className={`text-sm font-mono ${chartUi.value(surface)} tabular-nums`}>
      ...
      <div className={`flex justify-between text-xs font-mono ${chartUi.axis(surface)} mt-1`}>
        <span>older</span>
        <span className={surface === "light" ? "text-[#0d7377] tabular-nums" : "text-[#5eead4] tabular-nums"}>{(series[series.length - 1] * 100).toFixed(1)}%</span>
        <span>latest</span>
      </div>
    </div>
  );
...
export function RunVolumeBars({
  ...
  return (
    <div className={chartUi.card(surface)}>
      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
        <div>
          <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]" : "text-[#5eead4]"}`}>FASTQ pairs / run</p>
        ...
        {runs.map((r) => {
          ...
          return (
            <button
              key={r.id}
              type="button"
              className="flex-1 flex flex-col items-center gap-1 min-w-0 group focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0d7377]/40 rounded-t"
            ...
            >
              <div
                className="w-full max-w-[52px] mx-auto rounded-t transition-[filter,opacity] duration-300 ease-out"
                style={{
                  height: `${h}px`,
...
export function StageTimeStackBar({ surface = "dark" }: { surface?: ChartSurface }) {
  ...
  const stages = useMemo(
    () => [
      ...
      { label: "Call", pct: 28, className: "bg-[#0d7377]/80", estHrs: "~49 h" },
      {
        label: "Other",
        pct: 15,
  ...
  return (
    <div className={chartUi.card(surface)}>
      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
        <div>
          <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]" : "text-[#5eead4]"}`}>Cluster time (7d)</p>
        ...
        <ChartMetricSlot
          ...
          ghost={
            <div className="rounded-lg border border-transparent px-2.5 py-1.5">
              <p className="text-xs font-medium tracking-wide">Align</p>
        ...
        >
          {stages.map((s) => (
            <button
              ...
              className={`h-full min-w-[6px] ${s.className} transition-[filter] duration-200 hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#0d7377]/50`}
              style={{ width: `${s.pct}%` }}
...
export function ReportVolumeBars({ surface = "dark" }: { surface?: ChartSurface }) {
  ...
  return (
    <div className={chartUi.card(surface)}>
      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
        <div>
          <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]" : "text-[#5eead4]"}`}>PDFs generated / week</p>
        ...
        <ChartMetricSlot
          ...
          ghost={
            <div className="rounded-lg border border-transparent px-2.5 py-1.5">
              <p className="text-xs font-medium tracking-wide">W14</p>
        ...
        >
          {hoverWeek ? (
            <div className={chartUi.metricPdf(surface)}>
              <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]/90" : "text-[#5eead4]/90"}`}>{hoverWeek.w}</p>
        ...
        {weeks.map((wk) => {
          ...
          return (
            <button
              key={wk.w}
              type="button"
              className="flex-1 flex flex-col items-center gap-1 group min-h-0 justify-end focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0d7377]/40 rounded pb-0.5"
                ...
                className={
                  surface === "light"
                    ? `w-full rounded-t bg-gradient-to-t transition-all duration-300 ${
                        active
                          ? "from-[#0d7377]/35 to-[#0d7377]/75"
                          : "from-[#0d7377]/18 to-[#0d7377]/52 group-hover:from-[#0d7377]/28 group-hover:to-[#0d7377]/68"
                      }`
                    : `w-full rounded-t bg-gradient-to-t from-[#0d7377]/20 to-[#0d7377]/70 transition-all duration-300 group-hover:from-[#0d7377]/30 group-hover:to-[#0d7377]/85 ${
                        active ? "from-[#0d7377]/30 to-[#0d7377]/85" : ""
                      }`
                }
...
export function ReportPagesStack({ surface = "dark" }: { surface?: ChartSurface }) {
  ...
  const parts = useMemo(
    () => [
      ...
      { key: "var", label: "Variants", pct: 44, className: "bg-[#0d7377]/75", pages: "~6 pg" },
      {
        key: "app",
        label: "Appendix",
        pct: 24,
  ...
  return (
    <div className={chartUi.card(surface)}>
      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
        <div>
          <p className={`text-xs font-medium tracking-wide ${surface === "light" ? "text-[#0d7377]" : "text-[#5eead4]"}`}>Typical page budget</p>
        ...
        <ChartMetricSlot
          ...
          ghost={
            <div className="rounded-lg border border-transparent px-2.5 py-1.5">
              <p className="text-xs font-medium tracking-wide truncate">QC + depth</p>
              <p className="text-sm font-mono tabular-nums">99%</p>
        ...
        >
          {hoverPart ? (
            <div className={chartUi.metricBox(surface)}>
              <p
                className={`text-xs font-medium tracking-wide ${chartUi.sub9(surface)} truncate`}
        ...
        >
          {parts.map((p) => (
            <button
              ...
              onBlur={() => setHoverKey(null)}
              className={`h-full min-w-[8px] ${p.className} transition-[filter] duration-200 hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#0d7377]/50`}
              style={{ width: `${p.pct}%` }}
